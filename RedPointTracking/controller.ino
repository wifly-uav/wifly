...
//uint8_t castAddress[] = {0xB4, 0xE6, 0x2D, 0x2F, 0x80, 0x90}; // 10
uint8_t castAddress[] = {0xB4, 0xE6, 0x2D, 0x2F, 0x8D, 0x57}; //11 神永作
//uint8_t castAddress[] = {0xB4, 0xE6, 0x2D, 0x2F, 0x90, 0xA9}; //12
//uint8_t castAddress[] = {0xB4, 0xE6, 0x2D, 0x2F, 0x80, 0x34}; //13 
//uint8_t castAddress[] = {0xB4, 0xE6, 0x2D, 0x2F, 0x82, 0xF2}; // SHE
//uint8_t castAddress[] = {0xB4, 0xE6, 0x2D, 0x2F,0x86, 0xB4}; // 李さん作

esp_now_peer_info_t peerInfo;

const int controller_num = 2; //1:A 2:B　変数の値を変更せずに定数として宣言　書き換えできず読み取り専用
