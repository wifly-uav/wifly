...
class visual_nn:
    def __init__(self, flag=False, folder='log', max=[255,255,180,9], frame=4, norm=False):
        self.flag = flag
        self.folder = folder
        self.max = max
        self.frame = frame
...
if __name__ == "__main__":    
    ...
    vi = visual_nn(flag=True,folder=save_file, norm=True,frame=4,max=[255,255,90,1,50])
    vi.visualize()