...
;; File Name       : BM1422.c
	...
	$$TABbm1422$BM1422 segment table 2h #0h
	$$bm1422_get_rawval$BM1422 segment code 2h #0h
	$$bm1422_get_val$BM1422 segment code 2h #0h
	$$bm1422_init$BM1422 segment code 2h #0h
	$$bm1422_power_down$BM1422 segment code 2h #0h
	$$bm1422_read$BM1422 segment code 2h #0h
	$$bm1422_write$BM1422 segment code 2h #0h
CVERSION 3.53.1
CSGLOBAL 02H 0000H "bm1422_init" 08H 02H 3BH 01H 83H 0aH 00H 00H 00H
CSGLOBAL 02H 0000H "bm1422_read" 08H 02H 3AH 01H 83H 0eH 00H 00H 00H
CSGLOBAL 02H 0000H "bm1422_write" 08H 02H 39H 01H 83H 0aH 00H 00H 00H
CSGLOBAL 02H 0000H "bm1422_power_down" 08H 02H 3EH 01H 83H 08H 00H 00H 00H
CSGLOBAL 02H 0000H "bm1422_get_rawval" 08H 02H 3CH 01H 83H 0aH 00H 00H 00H
CSGLOBAL 02H 0000H "bm1422_get_val" 08H 02H 3DH 01H 83H 18H 00H 00H 00H
...
CSTRUCTMEM 42H 00000002H 00000004H "get_rawval" 0AH 03H 00H 02H 37H 01H 00H 00H 00H 00H 00H
...
CGLOBAL 01H 01H 0008H "bm1422" 04H 00H 05H 1FH 00H
CGLOBAL 02H 01H 0014H "Wire" 04H 00H 05H 1EH 00H
CFILE 0001H 00000039H "C:\\LAZURI~1\\LIBRAR~1\\Wire\\Wire.h"
...
CFILE 001CH 00000031H "C:\\LAZURI~1\\LIBRAR~1\\BM1422\\bm1422.h"
CFILE 0000H 000000AFH "C:\\LAZURI~1\\LIBRAR~1\\BM1422\\BM1422.c"

	rseg $$bm1422_write$BM1422
CFUNCTION 313
...
CLINEA 0000H 0001H 0020H 0003H 0029H
	l	r0,	NEAR _device_address
	l	er2,	NEAR _Wire+08h
	bl	er2

;;  Wire.write_byte(memory_address);
CLINEA 0000H 0001H 0021H 0003H 0022H
	mov	r0,	r8
	l	er2,	NEAR _Wire+0ah
	bl	er2

;;  Wire.write(data, size);
CLINEA 0000H 0001H 0022H 0003H 0019H
	l	r2,	_size$4[fp]
	mov	r3,	#00h
	mov	er0,	er10
...
CLINEA 0000H 0000H 0023H 0003H 0022H
	mov	r0,	#01h
	l	er2,	NEAR _Wire+0eh
	bl	er2

;;  return (rc);
CLINEA 0000H 0001H 0024H 0003H 000EH
CBLOCKEND 313 2 37

;;}
CLINEA 0000H 0000H 0025H 0001H 0001H
	pop	er4
	pop	xr8
	mov	sp,	fp
	pop	fp
...
CLOCAL 46H 0001H 001AH 0002H "rc" 02H 00H 00H
CLOCAL 46H 0001H 0018H 0002H "cnt" 02H 00H 00H

;;  Wire.beginTransmission(device_address);
CLINEA 0000H 0001H 002CH 0003H 0029H
	l	r0,	NEAR _device_address
	l	er2,	NEAR _Wire+08h
	bl	er2

;;  Wire.write_byte(memory_address);
CLINEA 0000H 0001H 002DH 0003H 0022H
	mov	r0,	r8
	l	er2,	NEAR _Wire+0ah
	bl	er2

;;  rc = Wire.endTransmission(false);
CLINEA 0000H 0000H 002EH 0003H 0023H
	mov	r0,	#00h
	l	er2,	NEAR _Wire+0eh
	bl	er2
	mov	r6,	r0	;; _lrc$0
...
;;  if (rc != 0) {
CLINEA 0000H 0001H 002FH 0003H 0010H
	cmp	r0,	#00h
	beq	_$L2
CBLOCK 314 3 47
CBLOCKEND 314 3 49
...
;;  }
CLINEA 0000H 0000H 0031H 0003H 0003H
_$L2 :

;;  Wire.requestFrom(device_address, size, true);
CLINEA 0000H 0001H 0033H 0003H 002FH
	mov	r2,	#01h
	l	r1,	_size$4[fp]
	l	r0,	NEAR _device_address
...
;;  cnt = 0;
CLINEA 0000H 0001H 0034H 0003H 000AH
	mov	r4,	#00h	;; _lcnt$2

;;  }
CLINEA 0000H 0000H 0038H 0003H 0003H
_$L8 :

;;  while(Wire.available()) {
CLINEA 0000H 0001H 0035H 0003H 001BH
...
;;    data[cnt] = Wire.read();
CLINEA 0000H 0000H 0036H 0005H 001CH
...
;;    cnt++;
CLINEA 0000H 0000H 0037H 0005H 000AH
	add	r4,	#01h
CBLOCKEND 314 4 56
...
;;  return (rc);
CLINEA 0000H 0000H 003AH 0003H 000EH
CBLOCKEND 314 1 59
CFUNCTIONEND 314


	rseg $$bm1422_init$BM1422
CFUNCTION 315
...
CLINEA 0000H 0000H 0045H 0003H 0032H
	mov	er0,	#1 
	push	er0
	mov	er2,	fp
	add	er2,	#-1
...
CLINEA 0000H 0001H 004DH 0003H 001EH
	l	r0,	_reg$2[fp]
	cmp	r0,	#041h
	bne	_$L9
CBLOCK 315 4 77
...
;;    return (rc);
CLINEA 0000H 0000H 004FH 0005H 0010H
CBLOCKEND 315 4 80

;;  reg = 0xC2;
CLINEA 0000H 0001H 0053H 0003H 000DH
	mov	r0,	#0c2h
	st	r0,	_reg$2[fp]

;;  rc = bm1422_write(BM1422_CNTL1, &reg, sizeof(reg));
CLINEA 0000H 0000H 0054H 0003H 0035H
	mov	r0,	#01h
	push	r0
	mov	er2,	fp
	add	er2,	#-1
...
;;  if (rc != 0) {
CLINEA 0000H 0001H 0055H 0003H 0010H
	cmp	r0,	#00h
	bne	_$L9
CBLOCK 315 5 85

;;    return (rc);
CLINEA 0000H 0000H 0057H 0005H 0010H
CBLOCKEND 315 5 88

;;  buf[0] = 0x00;
CLINEA 0000H 0001H 005AH 0003H 0010H
	mov	r0,	#00h
	st	r0,	_buf$4[fp]

;;  buf[1] = 0x00;
CLINEA 0000H 0001H 005BH 0003H 0010H
	st	r0,	_buf$4+01h[fp]

;;  rc = bm1422_write(BM1422_CNTL4, buf, sizeof(buf));
CLINEA 0000H 0000H 005CH 0003H 0034H
	mov	r0,	#02h
	push	r0
	mov	er2,	fp
	add	er2,	#-4
...
;;  if (rc != 0) {
CLINEA 0000H 0001H 005DH 0003H 0010H
	cmp	r0,	#00h
	bne	_$L9
CBLOCK 315 6 93

;;    return (rc);
CLINEA 0000H 0000H 005FH 0005H 0010H
CBLOCKEND 315 6 96

;;  reg = 0x08;
CLINEA 0000H 0001H 0063H 0003H 000DH
	mov	r0,	#08h
	st	r0,	_reg$2[fp]

;;  rc = bm1422_write(BM1422_CNTL2, &reg, sizeof(reg));
CLINEA 0000H 0000H 0064H 0003H 0035H
	mov	r0,	#01h
	push	r0
	mov	er2,	fp
	add	er2,	#-1
...
;;  if (rc != 0) {
CLINEA 0000H 0001H 0065H 0003H 0010H
	cmp	r0,	#00h
	bne	_$L9
CBLOCK 315 7 101

;;    return (rc);
CLINEA 0000H 0000H 0067H 0005H 0010H
CBLOCKEND 315 7 104

;;  return (rc);  
CLINEA 0000H 0000H 006CH 0003H 0010H
	bal	_$L9
CBLOCKEND 315 1 109
CFUNCTIONEND 315


	rseg $$bm1422_get_rawval$BM1422
CFUNCTION 316
...
;;  reg = 0x40;
CLINEA 0000H 0001H 0075H 0003H 000DH
	mov	r0,	#040h
	st	r0,	_reg$2[fp]

;;  rc = bm1422_write(BM1422_CNTL3, &reg, sizeof(reg));
CLINEA 0000H 0000H 0076H 0003H 0035H
	mov	r0,	#01h
	push	r0
	mov	er2,	fp
	add	er2,	#-1
...
;;  if (rc != 0) {
CLINEA 0000H 0001H 0077H 0003H 0010H
	cmp	r0,	#00h
	beq	_$L24
CBLOCK 316 3 119
CBLOCKEND 316 3 122
...
;;  }
CLINEA 0000H 0000H 007AH 0003H 0003H
_$L24 :

;;  delayMicroseconds(500);
CLINEA 0000H 0001H 007BH 0003H 0019H
	mov	r0,	#0f4h
	mov	r1,	#01h
	mov	er2,	#0 
...
CLINEA 0000H 0000H 007CH 0003H 002AH
	mov	er0,	#6 
	push	er0
	mov	er2,	er8
	mov	r0,	#010h
...
;;  return (rc);  
CLINEA 0000H 0000H 0081H 0003H 0010H
	bal	_$L23
CBLOCKEND 316 1 130
CFUNCTIONEND 316


	rseg $$bm1422_get_val$BM1422
CFUNCTION 317
...
CBLOCK 317 2 133
CRET 0012H
CARGUMENT 47H 0002H 0028H "data" 04H 03H 00H 00H 03H
CLOCAL 46H 0001H 001EH 0002H "rc" 02H 00H 00H
CLOCAL 42H 0006H 0006H 0002H "val" 05H 01H 06H 00H 00H 00H
CLOCAL 43H 0006H 000CH 0002H "mag" 05H 01H 03H 00H 00H 08H

;;  rc = bm1422_get_rawval(val);
CLINEA 0000H 0000H 008AH 0003H 001EH
	mov	er0,	fp
	add	er0,	#-6
	bl	_bm1422_get_rawval
	mov	r10,	r0	;; _lrc$0

;;  if (rc != 0) {
CLINEA 0000H 0001H 008BH 0003H 0010H
	cmp	r0,	#00h
	beq	_$L29
CBLOCK 317 3 139
CBLOCKEND 317 3 141
...
;;  } 
CLINEA 0000H 0000H 008DH 0003H 0004H
_$L29 :

;;  mag[0] = ((signed short)val[1] << 8) | (val[0]);
CLINEA 0000H 0001H 008FH 0003H 0032H
	l	r0,	_val$2+01h[fp]
	mov	r1,	#00h
	mov	r3,	r0
	l	r0,	_val$2[fp]
...
CLINEA 0000H 0001H 0090H 0003H 0032H
	l	r0,	_val$2+03h[fp]
	mov	r1,	#00h
	mov	r3,	r0
	l	r0,	_val$2+02h[fp]
	or	r1,	r3
	st	er0,	_mag$8+02h[fp]

;;  mag[2] = ((signed short)val[5] << 8) | (val[4]);
CLINEA 0000H 0001H 0091H 0003H 0032H
	l	r0,	_val$2+05h[fp]
	mov	r1,	#00h
	mov	r3,	r0
	l	r0,	_val$2+04h[fp]
	or	r1,	r3
	st	er0,	_mag$8+04h[fp]

;;  data[0] = (float)mag[0];
CLINEA 0000H 0001H 0093H 0003H 001AH
	l	er0,	_mag$8[fp]
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
;;  data[1] = (float)mag[1];
CLINEA 0000H 0001H 0094H 0003H 001AH
	l	er0,	_mag$8+02h[fp]
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
;;  data[2] = (float)mag[2];
CLINEA 0000H 0001H 0095H 0003H 001AH
	l	er0,	_mag$8+04h[fp]
	mov	r2,	r1
	extbw	er2
	mov	r2,	r3
...
;;  return (rc);  
CLINEA 0000H 0000H 0097H 0003H 0010H
	bal	_$L28
CBLOCKEND 317 1 152
CFUNCTIONEND 317


	rseg $$bm1422_power_down$BM1422
CFUNCTION 318
...
;;  reg = 0x20;
CLINEA 0000H 0001H 009FH 0003H 000DH
	mov	r0,	#020h
	st	r0,	_reg$2[fp]

;;  rc = bm1422_write(BM1422_CNTL1, &reg, sizeof(reg));
CLINEA 0000H 0000H 00A0H 0003H 0035H
	mov	r0,	#01h
	push	r0
	mov	er2,	fp
	add	er2,	#-1
...
;;  return (rc);
CLINEA 0000H 0001H 00A5H 0003H 000EH
CBLOCKEND 318 2 166

;;}
CLINEA 0000H 0000H 00A6H 0001H 0001H
	mov	sp,	fp
	pop	fp
	pop	pc
CBLOCKEND 318 1 166
CFUNCTIONEND 318
	...
	rseg $$TABbm1422$BM1422
_bm1422 :
	dw	_bm1422_init
	dw	_bm1422_get_val
	dw	_bm1422_get_rawval
	dw	_bm1422_power_down
