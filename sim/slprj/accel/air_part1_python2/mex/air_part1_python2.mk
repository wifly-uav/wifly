...
MODULES                 = air_part1_python2_acc.c air_part1_python2_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\air_part1_python2_acc.mexw64
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:air_part1_python2_acc.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
MODELLIB                  = air_part1_python2_acc.mexw64
MODELREF_LINK_LIBS        = 
...
air_part1_python2_acc.obj : $(START_DIR)\slprj\accel\air_part1_python2\air_part1_python2_acc.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\air_part1_python2\air_part1_python2_acc.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\air_part1_python2\air_part1_python2_acc.c

air_part1_python2_acc_data.obj : $(START_DIR)\slprj\accel\air_part1_python2\air_part1_python2_acc_data.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\air_part1_python2\air_part1_python2_acc_data.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\air_part1_python2\air_part1_python2_acc_data.c

rtGetInf.obj : $(START_DIR)\slprj\accel\air_part1_python2\rtGetInf.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\air_part1_python2\rtGetInf.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\air_part1_python2\rtGetInf.c

rtGetNaN.obj : $(START_DIR)\slprj\accel\air_part1_python2\rtGetNaN.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\air_part1_python2\rtGetNaN.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\air_part1_python2\rtGetNaN.c

rt_nonfinite.obj : $(START_DIR)\slprj\accel\air_part1_python2\rt_nonfinite.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\air_part1_python2\rt_nonfinite.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\air_part1_python2\rt_nonfinite.c
