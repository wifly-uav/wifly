...
MODEL                   = air_part1_python2
MODULES                 = coder_posix_time.c rt_matrx.c rt_printf.c air_part1_python2.c air_part1_python2_capi.c air_part1_python2_data.c air_part1_python2_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi_simtarget.c rtw_modelmap_utils_simtarget.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c slasciidecode.cpp slasciiencode.cpp
PRODUCT                 = air_part1_python2.exe
MAKEFILE                = air_part1_python2.mk
MATLAB_ROOT             = C:\Program Files\MATLAB\R2022b
ALT_MATLAB_ROOT         = C:\PROGRA~1\MATLAB\R2022b
START_DIR               = C:\Users\riku3\wifly\sim
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = air_part1_python2_ref.rsp
COMPILER_COMMAND_FILE     = air_part1_python2_comp.rsp
...
!if $(INTEGER_CODE) == 0
!if "$(MODELREF_TARGET_TYPE)" == "SIM"
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\slrealtime\simulink\blocks\dist\win64\lib\libecatinterface.a_rtwsfcn_vcx64.lib
!else
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\slrealtime\simulink\blocks\dist\win64\lib\libecatinterface.a_ert_vcx64.lib
!endif
!else
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\slrealtime\simulink\blocks\dist\win64\lib\libecatinterface.a_int_ert_vcx64.lib
!endif
!else
LIBS = $(LIBS) libecatinterface.a.lib
!endif

!if "$(OPT_OPTS)" == "$(DEFAULT_OPT_OPTS)"
!if $(INTEGER_CODE) == 0
!if "$(MODELREF_TARGET_TYPE)" == "SIM"
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\slrealtime\simulink\blocks\dist\win64\lib\libEcMaster.a_rtwsfcn_vcx64.lib
!else
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\slrealtime\simulink\blocks\dist\win64\lib\libEcMaster.a_ert_vcx64.lib
!endif
!else
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\slrealtime\simulink\blocks\dist\win64\lib\libEcMaster.a_int_ert_vcx64.lib
!endif
!else
LIBS = $(LIBS) libEcMaster.a.lib
!endif

!if "$(OPT_OPTS)" == "$(DEFAULT_OPT_OPTS)"
!if $(INTEGER_CODE) == 0
!if "$(MODELREF_TARGET_TYPE)" == "SIM"
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\slrealtime\simulink\blocks\dist\win64\lib\libslrealtime_libsrc_pervar.a_rtwsfcn_vcx64.lib
!else
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\slrealtime\simulink\blocks\dist\win64\lib\libslrealtime_libsrc_pervar.a_ert_vcx64.lib
!endif
!else
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\slrealtime\simulink\blocks\dist\win64\lib\libslrealtime_libsrc_pervar.a_int_ert_vcx64.lib
!endif
!else
LIBS = $(LIBS) libslrealtime_libsrc_pervar.a.lib
!endif
...
{$(MATLAB_ROOT)\toolbox\slrealtime\simulink\blocks}.c.obj :
...
{$(MATLAB_ROOT)\toolbox\slrealtime\simulink\blocks}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<
...
slasciidecode.obj : $(MATLAB_ROOT)\toolbox\slrealtime\simulink\blocks\slasciidecode.cpp
	@cmd /C "echo ### Compiling $(MATLAB_ROOT)\toolbox\slrealtime\simulink\blocks\slasciidecode.cpp
	$(CC) $(CPPFLAGS) $(MATLAB_ROOT)\toolbox\slrealtime\simulink\blocks\slasciidecode.cpp

slasciiencode.obj : $(MATLAB_ROOT)\toolbox\slrealtime\simulink\blocks\slasciiencode.cpp
	@cmd /C "echo ### Compiling $(MATLAB_ROOT)\toolbox\slrealtime\simulink\blocks\slasciiencode.cpp
	$(CC) $(CPPFLAGS) $(MATLAB_ROOT)\toolbox\slrealtime\simulink\blocks\slasciiencode.cpp
