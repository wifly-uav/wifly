...
W_fc1 = np.loadtxt('nn/debug_W_fc1.csv', delimiter=',')
W_fc2 = np.loadtxt('nn/debug_W_fc2.csv', delimiter=',')
W_out = np.loadtxt('nn/debug_W_out.csv', delimiter=',')
input_layer = W_fc1.shape[0]
middle_layer_1 = W_fc1.shape[1]
middle_layer_2 = W_fc2.shape[1]
output_layer = W_out.shape[1]

b_fc1 = np.loadtxt('nn/debug_b_fc1.csv', delimiter=',')
b_fc2 = np.loadtxt('nn/debug_b_fc2.csv', delimiter=',')
b_out = np.loadtxt('nn/debug_b_out.csv', delimiter=',')
