...
LEFT_SERVO = 3
RIGHT_SERVO = 4
PWM_WING = 100       #実質50,254~0としてPWM値は反転されていることに注意
default_params = [255, PWM_WING, PWM_WING, 90, 90, 0]    
...
class Environment():
    ...
    def excute_action(self, action):
        ...
        """
        if action == 0:
            self.params_to_send[LEFT_SERVO] = 0
            self.params_to_send[RIGHT_SERVO] = 180
        elif action == 1:
            self.params_to_send[LEFT_SERVO] = 30
            self.params_to_send[RIGHT_SERVO] = 150
        elif action == 2:
            ...
            self.params_to_send[LEFT_SERVO] = 150
            self.params_to_send[RIGHT_SERVO] = 30
        elif action == 6:
            self.params_to_send[LEFT_SERVO] = 180
            self.params_to_send[RIGHT_SERVO] = 0
